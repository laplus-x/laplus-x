...
const Education = () => {
  ...
  return (
    <div>
      <h2 className="text-gray-800 font-semibold uppercase">{t("title")}</h2>
      <div className="flex flex-col mt-2 text-xs text-gray-700 gap-1">
                ...
                <div className="pl-8 pt-2">
                  ...
                  <ul className="flex flex-wrap text-xs/2 pt-1 gap-1">
                    {exp.stack.map((i: any) => (
                      <li
                        key={i}
                        className="px-3 py-1 mb-1 rounded-full border"
                      >
                        {i}
                      </li>
                    ))}
...
const Copyright = () => (
  <div className="flex justify-between text-gray-800 text-sm">
    ...
    <a
      ...
      href="https://laplus-x.github.io/laplus-x#cv"
    >
