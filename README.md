...
## [weather-mcp-server](https://github.com/laplus-x/weather-mcp-server)

在這個小型 MCP 專案中，展現了快速掌握 MCP 標準與整合工具之能力，能以 功能優先 的態度設計專案：專注提供「天氣新聞稿」生成這一核心能力，透過 HTTP /mcp 端點承載 MCP 功能，簡潔框架加上 TypeScript 與容器化支援，讓系統具備未來擴充與部署可能。專案架構清晰、強調開發流程與最佳實踐，呈現出從工具選型、系統整合到開源設計的一條龍能力。

| **項目**       | **內容**                                        |
| -------------- | ----------------------------------------------- |
| **Tech Stack** | `TS` `MCP` `vite` `vitest` `Monolith` `chatgpt` |
